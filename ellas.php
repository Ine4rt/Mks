...
let titrePack = (role === 'Ellas-Keeper') ? 'Pack Ellas Keeper' : 'Pack Ellas';


if (role === "Ellas-Keeper") {
    var titles = {
			veste: "Veste",
        pantalon: "Pantalon",
        kit: "Kit",
    ...
    font-weight: normal;
                        ...
                        <body>
                            <div class="container">
                                ...
                                <img src="ellas.png" class="logo" alt="Logo Club">
                                <h2>${titrePack}</h2>
    ...
    <div class="item-size">${veste}</div>
        ...
        <div class="item-box">
            <div class="item-title">${titles.bas}
                <div class="item-reference">${references.bas}</div> <!-- Nouveau bloc pour la référence -->
            </div>
...
<body>
    ...
    <div class="club-container">
        <img src="ellas.png" alt="Ellas" class="club-logo">
        <span style="font-size: 40px; font-weight: bold;">Ellas</span>
...
<div id="filterContainer">
    ...
    <button class="filter-btn" onclick="filterByRole('Ellas-Joueur', this)">Joueur</button>
    <button class="filter-btn" onclick="filterByRole('Ellas-Keeper', this)">Keeper</button>
	<button class="filter-btn" onclick="filterByRole('Ellas-Entraîneur', this)">Entraineur</button>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Veste </br> 100527511</th>
                <th>Pantalon </br> 100530403</th>
                <th>Kit </br> 100345111</th>
                <th>Bas </br> 100369701</th>
                <th>Initiales</th>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM orders WHERE club = 'Ellas'";
...
echo "<td>" . $date->format('d/m') . "</td>";
                ...
                echo "'>";
                if ($row['role'] == 'Ellas-Joueur') {
                    echo "⚽️"; // Icône ballon de foot
                } elseif ($row['role'] == 'Ellas-Keeper') {
                    echo "🧤"; // Icône paire de gants
                } elseif ($row['role'] == 'Ellas-Entraîneur') {
                    echo "🧤"; // Icône paire de gants
                }
                echo "</td>";
...
function toggleFilter() {
    ...
    if (currentFilter === "all") {
        currentFilter = "Ellas-Joueur";
        button.textContent = "Afficher: Joueur";
    } else if (currentFilter === "Joueur") {
        currentFilter = "Ellas-Keeper";
        button.textContent = "Afficher: Keeper";
    } else if (currentFilter === "Ellas-Entraîneur") {
        currentFilter = "Ellas-Entraîneur";
        button.textContent = "Afficher: Entraineur";
    } else {
        currentFilter = "all";
    ...
    rows.forEach(row => {
        ...
        if (roleCell) {
            ...
            if (currentFilter === "all" || role === "⚽️" && currentFilter === "Ellas-Joueur" || role === "🧤" && currentFilter === "Ellas-Keeper") {
                row.style.display = "";
            } else {
...
function filterByRole(role, button) {
    ...
    rows.forEach(row => {
        ...
        if (roleCell) {
            ...
            if (role === "all" || (role === "Ellas-Joueur" && roleText === "⚽️") || (role === "Ellas-Keeper" && roleText === "🧤")) {
                row.style.display = "";
            } else {
                row.style.display = "none";
            }
