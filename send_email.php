...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'info@ineart.be';
    $mail->Password = 'Choukroutraxou12';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;

    // Expéditeur et destinataire
    $mail->setFrom('info@ineart.be', 'Marksports Arena');
    $mail->addAddress($email, "$clientFirstname $clientName");
    $mail->addReplyTo('info@ineart.be', 'Marksports Arena');
    ...
    $body = "
		...
		<p>Votre pack est disponible en magasin du lundi au samedi de 10h00 à 12h30 et de 13h00 à 18h00.</p>
