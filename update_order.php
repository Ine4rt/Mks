...
elseif ($field === 'jacket_missing' || $field === 'pants_missing' || $field === 'kit_missing' || $field === 'under_shirt_missing' || $field === 'short_missing' || $field === 'bas_missing' || $field === 'jersey_missing' || $field === 'polo_missing' || $field === 'option_kway_missing') {  
